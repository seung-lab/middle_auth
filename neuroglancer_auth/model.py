...
class GroupDataset(db.Model):
    ...
    can_view = db.Column('can_view', db.Boolean, server_default=False, nullable=False)
    can_edit = db.Column('can_edit', db.Boolean, server_default=False, nullable=False)
    can_admin = db.Column('can_admin', db.Boolean, server_default=False, nullable=False)
