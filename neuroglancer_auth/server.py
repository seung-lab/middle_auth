...
def oauth2callback():
    ...
    if new_account:
        return redirect_with_args(
            flask.url_for("user_settings_bp.register_choose_username_view"), token
        )
    else:
...
def register_choose_username_post():
    ...
    if form_custom:
        ...
        if same_custom or UserCustomName.add(user.id, form_custom):
            ...
            return maybe_handle_tos(
                user,
                flask.g.auth_token,
                "msg.jinja",
                {
                    "title": "User Settings Updated",
                    "msg": f"Your username was changed to {form_custom}",
                },
            )
        else:
        ...
        return maybe_handle_tos(
            ...
            {
                "title": "User Settings Updated",
                "msg": "Your username was reset to the one associated with your Google Account",
            },
        )
