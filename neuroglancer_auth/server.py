...
import uuid
import json
from .model import db, User, APIKey, Group, UserGroup, insert_and_generate_unique_token, delete_token
...
@mod.route('/group/<group_id>/permissions', methods=['GET'])
@auth_requires_admin
def get_permissions_from_group_route(group_id):
    group = Group.get_by_id(group_id)
