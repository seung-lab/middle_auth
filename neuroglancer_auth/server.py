...
def add_dataset_to_group_route(dataset_id):
    ...
    print("add_dataset_to_group_route")
    ...
    if data and 'group_id' in data:
        ...
        print(f"in the if: {permission_ids}")
...
@api_v1_bp.route('/table/<table_id>/root/<int:root_id>/testtesttest')
@auth_requires_permission('edit', public_table_key='table_id', public_node_key='root_id', service_token=os.environ.get('MA_SERVICE_ACCOUNT_TOKEN'))
def temp_temp_temp(table_id, root_id):
    return flask.jsonify("success!")
