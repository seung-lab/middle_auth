...
import json
from .dec import auth_required, auth_requires_admin, setPermissionLookupOverride
...
GLOBAL_SERVER = os.environ.get('GLOBAL_SERVER', AUTH_URL)
...
def user_settings_tokens():
    ...
    return flask.render_template('tokens-list.html', tokens=tokens, user=user, now=datetime.datetime.now(), middle_auth_url=GLOBAL_SERVER)
