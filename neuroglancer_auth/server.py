...
api_v1 = flask.Blueprint('api_v1', __name__, url_prefix='/auth/api/v1')
admin_site = flask.Blueprint('admin_site', __name__, url_prefix='/auth/admin')
...
@api_v1.route('/user/<int:user_id>/group')
@requires_some_admin
...
@api_v1.route('/user/<int:user_id>/permissions')
@auth_requires_admin
...
@api_v1.route('/dataset', methods=['GET'])
@auth_required
...
@api_v1.route('/dataset', methods=['POST'])
@auth_requires_admin
...
@api_v1.route('/dataset/<int:dataset_id>', methods=['GET'])
...
@api_v1.route('/dataset/<int:dataset_id>/admin/<int:user_id>', methods=['DELETE'])
@auth_requires_admin
def remove_admin_from_dataset(dataset_id, user_id):
    DatasetAdmin.remove(user_id=user_id, dataset_id=dataset_id)
    return flask.jsonify("success")

@api_v1.route('/dataset/<int:dataset_id>/group', methods=['GET'])
@requires_dataset_admin
...
@api_v1.route('/dataset/<int:dataset_id>/group', methods=['POST'])
@requires_dataset_admin
...
@api_v1.route('/dataset/<int:dataset_id>/group/<int:group_id>', methods=['PUT'])
@requires_dataset_admin
...
@api_v1.route('/dataset/<int:dataset_id>/group/<int:group_id>', methods=['DELETE'])
@requires_dataset_admin
...
@api_v1.route('/group/<int:group_id>', methods=['GET'])
@requires_some_admin
...
@api_v1.route('/group/<int:group_id>/admin', methods=['GET'])
@requires_some_admin
...
@api_v1.route('/group/<int:group_id>/user', methods=['POST'])
...
@api_v1.route('/group/<int:group_id>/user/<int:user_id>', methods=['PUT'])
@auth_requires_admin
...
@api_v1.route('/group/<int:group_id>/user/<int:user_id>', methods=['DELETE'])
@requires_group_admin
...
@api_v1.route('/my_permissions')
@auth_required
def get_permissions():
    return flask.jsonify(User.get_by_id(flask.g.auth_user['id']).get_permissions())

@admin_site.route('/<path:path>', defaults={'path': 'index.html'})
