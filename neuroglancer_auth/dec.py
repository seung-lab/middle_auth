...
def auth_required(func=None, *, required_permission=None, public_table_key=None, public_node_key=None, service_token=None):
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            print(f"token:{token} - cookie_name:{cookie_name}")
            ...
            print(f"query_param_token:{query_param_token} - TOKEN_NAME:{TOKEN_NAME}")
            ...
            if programmatic_access:
                ...
                if query_param_token:
                    print(f"we are redirecting because this is not DBA")
